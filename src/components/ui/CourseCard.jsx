...
const CourseCard = ({course}) => {
 ...
 const {id,title,instructor,rating,category,instructor_img,duration,price,image,description,level}=course
...
<Chip  className="backdrop-blur-3xl bg-linear-[90deg,#6B38D4_0%,#BA0035_100%] text-white absolute  right-2 top-2 uppercase tracking-widest  ">{category}</Chip>
...
<p className="flex items-center gap-1"><RiBarChartFill />{level}</p>
