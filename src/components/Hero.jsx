...
const Hero = () => {
  ...
  return (
    <section className="max-w-7xl pl-7 md:pl-8 mx-auto my-20  rounded-2xl  shadow-sm w-[90%] bg-[linear-gradient(90deg,rgba(255,255,255,1),rgba(255,255,255,0.9),rgba(255,255,255,0)),url(/skillsphere-banner.png)] py-40 bg-no-repeat bg-center bg-cover"  >
    

    {/* hero area main infor */}
    <div className="max-w-xl w-[90%] space-y-5.75">
      <Chip className="uppercase text-(--primaryViolet) bg-[#efe9f7]">The Future of Learning is Here</Chip>
      <div>
