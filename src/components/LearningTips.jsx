...
<motion.div whileInView={{opacity:1,y:0}} initial={{opacity:0,y:30}} transition={{duration:0.9}} viewport={{once:true,margin:'-100px'}} className="p-10 lg:p-15 text-center flex flex-col gap-5 justify-center items-center bg-linear-to-b from-[#6B38D420] border border-(--outline) rounded-2xl to-white col-span-full md:col-span-2 xl:col-span-2 xl:row-span-2 ">
...
<motion.div whileInView={{opacity:1,y:0}} initial={{opacity:0,y:30}} transition={{duration:1}} viewport={{once:true,margin:'-100px'}} className=" p-10   flex flex-col text-center lg:text-left lg:flex-row gap-5 justify-center items-center border border-(--outline) rounded-2xl col-span-full  md:col-span-2">
...
<motion.div whileInView={{opacity:1,y:0}} initial={{opacity:0,y:30}} transition={{duration:1.1}} viewport={{once:true,margin:'-100px'}} className="p-10 text-center flex flex-col gap-5 justify-center items-center bg-linear-[160deg,#ffffff_0%,#6B38D420_100%] border border-(--outline) rounded-2xl to-white col-span-full md:col-span-2 xl:col-span-1">
...
<motion.div whileInView={{opacity:1,y:0}} initial={{opacity:0,y:30}} transition={{duration:1.2}} viewport={{once:true,margin:'-100px'}} className="p-10 text-center flex flex-col gap-5 justify-center items-center bg-linear-[160deg,#ffffff_0%,#6B38D420_100%] border border-(--outline) rounded-2xl to-whit col-span-full md:col-span-2 xl:col-span-1">
<div className="bg-[#6B38D420] rounded-full p-3">
