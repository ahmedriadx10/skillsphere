  ...
  const popularCourse=[
{
  ...
  return (
    <section className="py-20 bg-[#FAF8FF]">
      ...
      <motion.div className="text-center max-w-xl w-[90%] mx-auto space-y-4" whileInView={{opacity:1,y:0}} initial={{opacity:0,y:30}} transition={{duration:0.9}} viewport={{once:true,margin:"-100px"}}>
...
{popularCourse.map((course,inx)=><PopularCourseCard  key={course.id} inx={inx} course={course}/>)}
